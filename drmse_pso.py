...
# RMSE (Root Mean Squared Error) - For demonstration purposes
y_pred_probs = mdl.predict_proba(x_valid)[:, 1]
rmse = np.sqrt(mean_squared_error(ytest, y_pred_probs))
print("RMSE (For demonstration purposes):", rmse)
